---
name: human_handoff
description: Triggered when a user asks to speak to a real person. Collects their contact details, saves the lead, then runs notify_admins.py to send WhatsApp alerts to all admin numbers immediately.
---
...
> "Got it! I've alerted our team and someone will contact you on WhatsApp shortly. 📞"
...
This script sends a WhatsApp message to ALL THREE admin numbers:
- +923110800256
- +923332456988  
- +923369381947
